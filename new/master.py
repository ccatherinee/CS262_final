...
class MRJob: 
    def __init__(self, M, R):
        self.M, self.R = M, R
        self.initial_delay = INITIAL_DELAY # whether to delay assigning tasks for 10 seconds to allow all workers to connect first, for demonstration purposes only
